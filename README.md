...
- `-f`/`--filter`: Only check IDs with the given prefix. This is either the ID you explicitly give the sample, or `file-line`, e.g. `explicit-id-1234` or `filename-no-ext-1234`.
